  ...
  <div id="hy-swiper">
    ...
    <div class="indicator">
      <slot name="indicator" v-if="showIndicator && slideCount>1">
        ...
        <!--v-for遍历数字，item从1开始计数，index从0开始计数-->
        <!--给每个小圆点绑定一个key值，这样是为了高效的更新虚拟DOM-->
...
export default {
  ...
  methods: {
    ...
    scrollContent: function (currentPosition) {
      ...
      // 1.开始滚动动画，transform属性发生变化时，触发过渡效果
    ...
    /**
     * 设置滚动的位置
     * 给swiper添加属性：transform，-webkit-transform，-ms-transform
    ...
    handleDom: function () {
      ...
      if (this.slideCount > 1) {
        ...
        this.totalWidth = swiperEl.offsetWidth;// 375
    ...
    touchStart: function (event) {
      ...
      // 3.保存开始滚动的位置(横坐标),page包括滚动条滚动过去的长度，不是可视长度
